...
export function ShareModal({ isOpen, onClose, documentId, initialIsPublic }: ShareModalProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4 p-6 border border-gray-700"
        onMouseDown={(e) => e.stopPropagation()}
        onMouseUp={(e) => e.stopPropagation()}
      >
        <h2 className="text-xl font-bold mb-4 text-white">Share Document</h2>
          ...
          <div className="mb-6">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 border border-gray-600 rounded text-sm bg-gray-700 text-gray-100"
        ...
        <div className="flex justify-end gap-3">
          <button
            onClick={onClose}
            className="px-4 py-2 text-gray-200 hover:bg-gray-700 rounded transition-colors"
          >
            Close
          </button>
        </div>
